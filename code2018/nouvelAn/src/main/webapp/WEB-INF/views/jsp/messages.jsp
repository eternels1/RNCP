...
<body>
	<div class="container">
		<h2>Mes super Messages !</h2>
		<div class="well">
			<form method="post" action="addMessage">

				<div class="form-group">
					<label for="titre">Titre Message</label> <input type="text"
						class="form-control" id="titre" name="titre" />
				</div>
				<div class="form-group">
					<label for="titre">Corps Message</label> <input type="text"
						class="form-control" id="corps" name="corps" />
				</div>
