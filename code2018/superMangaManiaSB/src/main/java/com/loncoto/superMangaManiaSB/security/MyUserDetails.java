package com.loncoto.superMangaManiaSB.security;
...
public class MyUserDetails implements UserDetails {
	...
	public Collection<? extends GrantedAuthority> getAuthorities() {
		return this.utilisateur.getRoles().stream().map(r-> r.getRoleName())//attention, suppose que les roles sont de formes ROLE_..
